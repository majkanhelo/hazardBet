	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			<form action="" method="POST" class="form-signin">
        		...
        		<input type="password" name="password" value=${password } id="inputPassword" class="form-control" placeholder="Password"/>
        		Set your account:
        		<label for="inputAccountBalance" class="sr-only">Account balance</label>
        		<input type="number" name="account" value=${account } id="inputAccountBalance" class="form-control" placeholder="Account balance"/>
        		<hr>
				<div class="row">
	    			<div class="col-sm-6">
