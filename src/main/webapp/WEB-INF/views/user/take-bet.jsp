...
<body>
	...
	<form class="form-signin" action="" method="POST">
		Your bid
        <label for="inputBid" class="sr-only">Your bid</label>
     	<input type="number" name="betCash" min=0 max=${maxAccount} value=0 id="inputBid" class="form-control" placeholder="Your bid" required autofocus />	
        Your choice
        <label for="choice" class="sr-only">Your choice</label>
