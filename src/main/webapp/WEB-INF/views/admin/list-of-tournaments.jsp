...
<body>
  				...
  				<table class="table table-hover">
    				...
    				<tbody>
    					<c:forEach var="tournament" items="${tournaments}">
							<tr>
								<td>
									<a href="/admin/tournament/${tournament.id}">${tournament.name}</a>	
								</td>								
							</tr>							
						</c:forEach>			
    				</tbody>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4">
			<a href="/admin/addTournament"><input type="submit" value="Add new Tournament" class="btn btn-default btn-lg" /></a>		
		</div>
	</div>
