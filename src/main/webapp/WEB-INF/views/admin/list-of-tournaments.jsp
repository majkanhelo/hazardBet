...
.header {
	height: 80%;
	background: #11cc45
		url('http://www.bootply.com/assets/example/pt_squares_lg.png') repeat
		center center fixed;
}
...
.bright {
	background: #7fbbda
		url('http://www.bootply.com/assets/example/bg_suburb.jpg') no-repeat
		center center fixed;
	color: #fff;
}
...
.callout {
	...
	height: 100%;
	width: 100%;
	background: url('http://www.bootply.com/assets/example/bg_suburb.jpg')
...
<body>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading">List of registered tournaments</div>
				<table class="table table-hover">
					...
					<tbody>
						<c:forEach var="tournament" items="${tournaments}">
							<tr>
								<td><a href="/admin/tournament/${tournament.id}">${tournament.name}</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
	...
	<div class="row">
		<div class="col-sm-4 col-sm-offset-4">
			<a href="/admin/addTournament"><input type="submit"
				value="Add new Tournament" class="btn btn-default btn-lg" /></a>
		</div>
	</div>
